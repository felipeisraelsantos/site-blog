...
export const SupportSection = () => {
  return (
    <section className="relative pb-8 mt-8 md:py-10 bg-gray-700">
      <div className="absolute inset-0 hidden md:block bg-[url('/background-section-support.svg')] bg-cover bg-center bg-no-repeat opacity-90" />
